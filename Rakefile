task :gem do
  ...
  sh 'gcc -Wall -D_JNI_IMPLEMENTATION_ -I%JAVA_HOME%\include -I%JAVA_HOME%\include\win32 -Wl,--kill-at -shared src/main/c/WindowsConsole.c -o target/classes/ansicolor/windows/WindowsConsole64.dll'
